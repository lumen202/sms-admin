...
public class AttendanceController extends FXController {
    ...
    private static final String STUDENT_PROFILE_FXML = "/finalproject/admin/app/management/viewstudent/STUDENT_PROFILE.fxml";
    ...
    // private LocalDate getNextWeekStartDate(LocalDate weekEnd, int month) {
    // LocalDate nextDay = weekEnd.plusDays(1);
    // while (nextDay.getMonthValue() == month && isWeekend(nextDay)) {
    // nextDay = nextDay.plusDays(1);
    // }
    // return nextDay.getMonthValue() == month ? nextDay : null;
    // }
